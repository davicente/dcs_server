...
describe("Metrics Controller", () => {
    describe("Add and get metrics", () => {
        ...
        it("Trying to add not a number", async () => {
        ...
        it("Add float value to be rounded below to metric", async () => {
        ...
        it("Add float value to be rounded above to metric", async () => {
        ...
        it("Add value to be rounded to 0 to existing metric", async () => {
        ...
        it("Add several values to metric and sum value is incremented", async () => {
        ...
        it("Add values to different metrics and sum values are incremented correctly", async () => {
